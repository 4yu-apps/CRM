...
function MeetingRow({ m }: { m: Meeting }) {
  ...
  return (
    <Link
      href={`/ficha/${lead.id}`}
      className="flex items-center gap-3 rounded-[14px] border border-border bg-card px-4 py-3 shadow-[var(--shadow)] transition-colors hover:border-brand/40"
    >
