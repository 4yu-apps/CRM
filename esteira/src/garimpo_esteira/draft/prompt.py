...
SYSTEM_INSTRUCTION = (
    ...
    "PERGUNTE em vez de afirmar: va da conclusao pra curiosidade, nunca do diagnostico "
    "pra proposta. Exemplo: se nao sabe se eles estao no iFood, PERGUNTE ('voces ja "
    "trabalham com iFood?'), nao afirme ('voce depende do iFood').\n"
    ...
    "CTA tem que ser de baixo atrito: nunca 'vamos marcar uma call'.\n\n"
    ...
    "PROIBIDO (elimina qualquer uma dessas expressoes ou atitude):\n"
...
_SERVICE_BRIEF = {
    ...
    "design": (
        ...
        "Se o site estiver parado ou o IG abandonado, pergunte de leve: "
